...
<body class="page" data-page="page2">
    <!-- Cabecera -->
    <header></header>
    ...
    <main class="content-manual">
        <div class="parrafo">
            ...
            <h2 id="titulo-pagina"><?php echo getTexto($conn, 201, $idioma); ?></h2>
            <h3 id="titulo-descripcion"><?php echo getTexto($conn, 202, $idioma); ?></h3>
            <p id="parrafo-descripcion">
                <?php echo getTexto($conn, 203, $idioma); ?>
            </p>

            <img src="../Imagenes/ventana-seleccion.png" alt="Selección">

            <div class="linea">
                <div></div>
            </div>

            <h3 id="titulo-componentes"><?php echo getTexto($conn, 204, $idioma); ?></h3>
            <ol>

                <li><?php echo getTexto($conn, 205, $idioma); ?></li>
            </ol>
        </div>

        <!-- Botones -->
        <div class="botones">
            <input type="button" id="boton-anterior" onclick="abrirPagina('page1.php?lang=<?php echo $idioma; ?>')"
                value="<?php echo getTexto($conn, 113, $idioma); ?>">
            <input type="button" id="boton-siguiente" onclick="abrirPagina('page3.php?lang=<?php echo $idioma; ?>')"
    ...
    <p id="paginacion" class="paginacion">2</p>
